  ...
  try {
    ...
    const data = flights.map(flight => ({
      ...
      rocket: flight.rocket ? {
        id: flight.rocket.id,
        name: flight.rocket.name,
        diameter_mm: flight.rocket.diameterMm,
        length_mm: flight.rocket.lengthMm,
        dry_mass_g: flight.rocket.dryMassG,
        description: flight.rocket.description,
        user_id: flight.rocket.userId,
        created_at: flight.rocket.createdAt.toISOString(),
      } : undefined,
